...
int ads7870_cdrv_open(struct inode*, struct file*);
int ads7870_cdrv_release(struct inode*, struct file*);
ssize_t ads7870_cdrv_write(struct file*, const char __user*, size_t, loff_t*);
ssize_t ads7870_cdrv_read(struct file*, char __user*, size_t, loff_t*);
